...
<head>
  ...
  <!-- =======================================================
    Theme Name: Meetup
    Author: Apushev Yelaman and Kabzhanov Rizabek
  ======================================================= -->
</head>
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="buy-tickets"><a href="sign_in.html">Sign in</a></li>
          <li class="buy-tickets"><a href="sign_up.html">Sign up</a></li>
        </ul>
