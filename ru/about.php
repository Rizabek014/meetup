<?php $GLOBALS['filename'] = 'about'; include ('nav.php');?>
    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          <h2>Наша команда</h2>
          <p>Детальная информация он нашей команде.</p>
        </div>
        ...
        <div class="col-md-6">
            <div class="details">
              ...
              <p>Энтузиаст, который ищет место для размещения, чтобы обеспечить навыки развития IT.</p>
 
              <p>Я работаю backend разработчиком </p>

              <p>В последние годы работал репетитором в "IT school" в МУИТ, в настоящее время работает бэкенд-разработчиком в ООО " KazDream
                </p>
            </div>
          </div>            
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <div class="details">
              ...
              <p>В последние годы работал backend разработчиком в Chocomart
                </p>
            </div>
          </div>
        ...
        <div class="col-md-6">
            <div class="details">
              ...
              <div class="social">
                ...
                <p>В настоящее время работает аналитикв данных Forte Bank
                </p>
            </div>
          </div>
        </div>
