        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            <ul class="nav-menu nav-tabs">
              ...
              <li class="menu-active"><a href="#about">#хакатон</a></li>
              <li class="menu-active"><a href="#about">#марафон</a></li>
              <li class="menu-active"><a href="#about">#google</a></li>
              <li class="menu-active"><a href="#about">#спорт</a></li>
              <li class="menu-active"><a href="#about">#мероприятия</a></li>
              <li class="menu-active"><a href="#about">#готовка</a></li>
              <li class="menu-active"><a href="#about">#мобильное</a></li>
